...
const Cart = ({ setShowCart }) => {
  ...
  const { cartItem,setCartItem, handleRemoveCart, totalPrice, handleQuntityCount } =
    useContext(Context);
  const handlePlaceOrder = () => {
    ...
    navigate('/success', { state: { orderSummary: orderSummary } });
    setCartItem([])
                  ...
                  <div className="cart-all">
                    ...
                    <div className="cart-name">
                      ...
                      <div className="cart-count-1">
                        <span onClick={() => handleQuntityCount("dec", item)}>
                          -
                        </span>
                        <span>{item.quantity}</span>
                        <span onClick={() => handleQuntityCount("inc", item)}>
                          +
                        </span>
                      </div>
